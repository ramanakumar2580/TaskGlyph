...
"[project]/src/app/app/pricing/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)"); // Router for navigation
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$script$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/script.js [app-client] (ecmascript)"); // To load Razorpay
...
;
;
// --- AUTH CHECK (REPLACE THIS WITH YOUR ACTUAL AUTH HOOK) ---
// Example: const { session } = useSession(); const isLoggedIn = !!session;
const useAuth = ()=>{
    // TODO: Ikkada nee real logic pettu. Ippatiki 'true' peduthunna testing kosam.
...
function PricingSection() {
    ...
    const pricingTiers = [
        ...
        },
        {
            ...
            frequency: "/ month",
            description: "For personal organization.",
            features: [
                "Unlimited Tasks",
                "Personal Diary",
                "2 Devices"
        ...
        },
        {
            ...
            frequency: "/ month",
            description: "For teams & obsessives.",
            features: [
                "Everything in Pro",
    ...
    const handlePlanClick = async (tier)=>{
        // 1. Login Check
        if (!isLoggedIn) {
            router.push("/auth/signup"); // Login lekapothe Signup page ki pampinchu
            return;
        }
        // 2. Free Plan Logic
        if (tier.name === "Free") {
            router.push("/app/dashboard"); // Direct Dashboard ki
            return;
        }
        // 3. Paid Plan Logic (Razorpay)
        setLoadingTier(tier.name);
        try {
            await startPayment(tier);
        } catch (error) {
            console.error(error);
    ...
    const startPayment = async (tier)=>{
        ...
        const options = {
            key: ("TURBOPACK compile-time value", "rzp_test_RkGpKBWGw4z262"),
            amount: order.amount,
            currency: order.currency,
            name: "TaskGlyph",
            description: "".concat(tier.name, " Plan Subscription"),
            order_id: order.id,
            handler: async function(response) {
                // Step C: Verify & Update DB
                ...
                if (verifyData.success) {
                    ...
                    if (tier.name === "Basic") msg = "Basic Plan Activated! Enjoy Unlimited Access.";
                    if (tier.name === "Pro") msg = "Welcome to Pro! AI Features Unlocked. 🚀";
                    if (tier.name === "Ultra") msg = "Ultra Tier Unlocked! You are now a power user. 🔥";
                    alert(msg);
                    // RELOAD TO UPDATE NAVBAR & DASHBOARD
            ...
            theme: {
                color: tier.popular ? "#0f172a" : "#4f46e5"
            }
        };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].section, {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$script$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                fileName: "[project]/src/app/app/pricing/page.tsx",
                lineNumber: 170,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[400px] bg-indigo-200/20 blur-[100px] rounded-full -z-10"
            }, void 0, false, {
                fileName: "[project]/src/app/app/pricing/page.tsx",
                lineNumber: 173,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "text-4xl font-black text-slate-900 tracking-tight sm:text-5xl",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Choose the perfect plan for your workflow."
                            }, void 0, false, {
                                fileName: "[project]/src/app/app/pricing/page.tsx",
                                lineNumber: 181,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                className: "mt-8 bg-white p-1.5 rounded-full border border-slate-200 shadow-sm inline-flex relative",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                        layout: true,
                                        className: "absolute top-1.5 bottom-1.5 w-[50%] rounded-full bg-slate-900 shadow-md z-0 transition-all duration-300 ".concat(currency === "USD" ? "left-[50%]" : "left-1.5")
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/app/pricing/page.tsx",
                                        lineNumber: 187,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "relative z-10 px-6 py-2 rounded-full text-sm font-bold transition-colors ".concat(currency === "INR" ? "text-white" : "text-slate-600"),
                                        children: "🇮🇳 INR (₹)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/app/pricing/page.tsx",
                                        lineNumber: 193,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "relative z-10 px-6 py-2 rounded-full text-sm font-bold transition-colors ".concat(currency === "USD" ? "text-white" : "text-slate-600"),
                                        children: "🇺🇸 USD ($)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/app/pricing/page.tsx",
                                        lineNumber: 201,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 items-start",
                        children: pricingTiers.map((tier)=>{
                            const isPro = tier.popular;
                            const isLoading = loadingTier === tier.name;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                className: "relative flex flex-col p-6 rounded-3xl transition-all duration-300 group\n                  ".concat(isPro ? "bg-slate-900 text-white shadow-2xl scale-105 z-10" : "bg-white text-slate-900 border border-slate-200 shadow-xl hover:-translate-y-1", "\n                "),
                                children: [
                                    isPro && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest shadow-lg flex items-center gap-1",
                                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                className: "text-lg font-bold ".concat(isPro ? "text-indigo-300" : "text-indigo-600"),
                                                children: tier.name
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/app/pricing/page.tsx",
                                                lineNumber: 237,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "mt-2 text-sm ".concat(isPro ? "text-slate-300" : "text-slate-500"),
                                        ...
                                        children: tier.features.map((feature)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckIcon$3e$__["CheckIcon"], {
                                                        className: "w-4 h-4 ".concat(isPro ? "text-indigo-300" : "text-indigo-600")
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/app/pricing/page.tsx",
                                                        lineNumber: 266,
                                                        columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-sm ".concat(isPro ? "text-slate-300" : "text-slate-600"),
                                                        children: feature
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/app/pricing/page.tsx",
                                                        lineNumber: 271,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "w-full py-3.5 px-6 rounded-xl text-center text-sm font-bold transition-all duration-300 shadow-md flex items-center justify-center gap-2\n                    ".concat(isPro ? "bg-white text-slate-900 hover:bg-indigo-50" : "bg-slate-900 text-white hover:bg-slate-800", "\n                    ").concat(!!loadingTier && "opacity-50 cursor-not-allowed", "\n                  "),
...
_s(PricingSection, "Lnt5+5yAmF+SxCblz7QmvPf3nBQ=", false, function() {
    return [
...
//# sourceMappingURL=_794516ad._.js.map