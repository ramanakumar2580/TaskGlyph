...
function getSelectionRangeInColumn(tr, startColIndex) {
    let endColIndex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : startColIndex;
...
function getSelectionRangeInRow(tr, startRowIndex) {
    let endRowIndex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : startRowIndex;
...
var BubbleMenuView = class {
     ...
     */ this.resizeHandler = ()=>{
        ...
        this.transactionHandler = (param)=>{
            let { transaction: tr } = param;
...
//# sourceMappingURL=node_modules_87f5a143._.js.map